<div class="header navbar">
    <div class="header-container">
        ...
        <ul class="nav-right">
                        ...
                        {{--<ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">--}}
                            {{--<li><a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">--}}
                                    ...
                                    {{--<div class="peer peer-greed"><span><span--}}
                                                    {{--class="fw-500">John Doe</span> <span--}}
            ...
            {{--</li>--}}
            {{--<li class="notifications dropdown">--}}
                {{--<span class="counter bgc-blue">3</span> <a href=""--}}
            ...
            <li class="dropdown">
                <a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                    <div class="peer mR-10">
                        {!! auther()->getUser()->getAvatar()->getAsImgTag(["class"=>"w-2r bdrs-50p"]) !!}
                    </div>
                    <div class="peer"><span class="fsz-sm c-grey-900">{{auther()->getUser()->getName()}}</span></div>
                </a>
                <ul class="dropdown-menu fsz-sm">
                    ...
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="{{url("$scope/profile")}}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">--}}
